# This module builds and formats the Auto Service State Page workbook (pre-2.0).
#
# Same idea as HabPageCurrent.py — see HabPage.py's module docstring for the
# general pattern. Transcribed from the root-level AutoServicePageCurrent.py:
# State Territory Multiplier tables are built straight from the ratebook's
# own BP7_Peril_TerritorialFactor table (no network Territory Definitions
...
class Auto:
    ...
    # AutoServicePageCurrent.py checked NGIC first, which is backwards.
    ...
    def buildAutoPage(self, progress_callback=None):
        ...
        sheetSpecs += [
            ('TRBG', 'AS Table 3.C.1.a. State Territory Multiplier - Building', lambda: self.buildTerritoryMultiplier('Building'), False, True, 'PROGRAM_TR', None),
            ('TRPP', 'AS Table 3.C.1.a. State Territory Multiplier - BPP', lambda: self.buildTerritoryMultiplier('BPP'), False, True, 'PROGRAM_TR', None),
            ('TRLB', 'AS Table 3.C.1.a. State Territory Multiplier - Liability', lambda: self.buildTerritoryMultiplier('Liability'), False, True, 'PROGRAM_TR', None),
            ...
            ('LS', 'AS Table 3.C.4.f. Liability Size of Risk Modifier', self.buildLiabilitySizeRisk, False, True, 'LS_CURRENT', None),
