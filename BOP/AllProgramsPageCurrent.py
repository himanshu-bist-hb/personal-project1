...
class AllPrograms:
    ...
    def buildAllProgramsPage(self):
        ...
        AllPrograms.generateWorksheet('WHOBG', 'AS, FS, H, O, R, S, W Table 3.C.2.g.(1). Windstorm or Hail Deductible Factor - Per Occurrence Fixed Deductible Amount - Building', self.buildWHDeductibleFactor('Building'), False, True, layout_key='WHOBG_CURRENT')
        AllPrograms.generateWorksheet('WHOPP', 'AS, FS, H, O, R, S, W Table 3.C.2.g.(1). Windstorm or Hail Deductible Factor - Per Occurrence Fixed Deductible Amount - BPP', self.buildWHDeductibleFactor('BPP'), False, True, layout_key='WHOPP_CURRENT')
        ...
        AllPrograms.generateWorksheet('WHPBG', 'AS, FS, H, O, R, S, W Table 3.C.2.g.(3). Windstorm or Hail Deductible Factor - Percentage Deductible - Building', self.buildWHDeductiblePercentage('Building'), False, True, layout_key='WHPBG_CURRENT')
        AllPrograms.generateWorksheet('WHPPP', 'AS, FS, H, O, R, S, W Table 3.C.2.g.(3). Windstorm or Hail Deductible Factor - Percentage Deductible - BPP', self.buildWHDeductiblePercentage('BPP'), False, True, layout_key='WHPPP_CURRENT')
