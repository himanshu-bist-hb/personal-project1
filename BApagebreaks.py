...
This version uses Section-Aware grouping to keep tables and their notes 
together on a single page, preventing mid-table splits.
\"\"\"
...
def _clear_page_breaks(ws_com):
    \"\"\"Completely reset all manual and automatic page breaks for a clean slate.\"\"\"
    try:
