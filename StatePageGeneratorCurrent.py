...
import StatePageValidationTestCurrent as VT
import ClassModifierPageCurrent as C
import AllProgramsPageCurrent as PG
import AllPerilPageCurrent as AP
import AutoServicePageCurrent as AS
import FoodServicePageCurrent as FS
import HabPageCurrent as H
import OfficePageCurrent as O
import ServicePageCurrent as S
import RetailPageCurrent as R
import WholesalePageCurrent as W
...
if OptionalCoveragesApplies.get() == 1:
    OptionalCoverages = OP.OptionalCoverages(state, rateTables, perils, classCodes, perilsConversions, nEffective, rEffective, OptionalCoveragesApplies, EQTerritoryDefs, NGICRatebook, NACORatebook, NAFFRatebook, NICOFRatebook, MMRatebook, TerritoryDefsByST)
