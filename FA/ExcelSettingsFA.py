...
ExcelSettingsFA.py
==================
Excel workbook / worksheet factory for FA Rate Pages.
...
1.  ELIMINATED ~500 lines of copy-paste.
    ...
    FARates.py requires ZERO changes.
...
5.  PRESERVED every public method signature exactly — FARates.py callers
    require no changes.
...
class Excel:
    ...
    Typical usage (from FARates.Auto.buildFAPages):
        pages = ExcelSettingsFA.Excel(StateAbb, State, nEff, rEff, companies)
    ...
    def _apply_page_setup(self, ws) -> None:
        ...
        # NOTE: Do NOT set pageSetUpPr.fitToPage = True here. FApagebreaks.py
    ...
    def _apply_default_footer(self, ws) -> None:
        ...
        FARates.overideFooter() OVERWRITES it per-cluster after the sheet is
    ...
    # --------------------------------------------------------------------------
    #  BACKWARD-COMPATIBLE ALIASES  (FARates.py needs zero changes)
    # --------------------------------------------------------------------------
